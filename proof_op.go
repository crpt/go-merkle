...
type OpDecoder func(aceitypes.ProofOp) (ProofOperator, error)
...
func (prt *ProofRuntime) Decode(pop aceitypes.ProofOp) (ProofOperator, error) {
...
func (prt *ProofRuntime) DecodeProof(proof *aceitypes.ProofOps) (ProofOperators, error) {
...
func (prt *ProofRuntime) VerifyValue(proof *aceitypes.ProofOps, root []byte, keypath string, value []byte) (err error) {
	return prt.Verify(proof, root, keypath, [][]byte{value})
}

// TODO In the long run we'll need a method of classifcation of ops,
// whether existence or absence or perhaps a third?
func (prt *ProofRuntime) VerifyAbsence(proof *aceitypes.ProofOps, root []byte, keypath string) (err error) {
	return prt.Verify(proof, root, keypath, nil)
}

func (prt *ProofRuntime) Verify(proof *aceitypes.ProofOps, root []byte, keypath string, args [][]byte) (err error) {
